...
import { fetchQuote, fetchCompanyNews, toFinnhubSymbol, CandleData, FinnhubNewsItem } from '@/lib/api';
import { calcRSI, calcMACD, calcMFI, calcBollingerB } from '@/lib/indicators';
...
export default function StockDetail({ stock, currency, onBack, isBookmarked, onToggleBookmark }: StockDetailProps) {
  ...
  const [indicators, setIndicators] = useState<Indicators>({ rsi: null, macd: null, mfi: null, bb: null, live: false });
